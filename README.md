...
GRANT ALL ON DATABASE PLATFORM_DEV to ROLE TRANSFORM;
GRANT ALL ON ALL SCHEMAS IN DATABASE PLATFORM_DEV to ROLE TRANSFORM;
GRANT ALL ON FUTURE SCHEMAS IN DATABASE PLATFORM_DEV to ROLE TRANSFORM;
GRANT ALL ON ALL TABLES IN SCHEMA PLATFORM_DEV.RAW to ROLE TRANSFORM;
GRANT ALL ON FUTURE TABLES IN SCHEMA PLATFORM_DEV.RAW to ROLE TRANSFORM;
```
